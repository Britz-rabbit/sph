  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        <p @click="selectDefault(address, addressInfo)">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="(detail, index) in orderList.detailArrayList"
          :key="orderList.skuId"
        >
          <li>
            <img
...
export default {
  ...
  computed: {
    ...
    userDefaultAddress() {
      let address =
        this.addressInfo.find((element) => element.isDefault == 1) || {};
      return address;
    },
  },
  methods: {
    //选中默认地址，做法为排他
    selectDefault(address, addressInfo) {
   ...
   async submitOrder() {
      //需要携带的参数：交易编码
      let { tradeNo, detailArrayList } = this.orderList;
      //需要携带的其他参数
      let data = {
